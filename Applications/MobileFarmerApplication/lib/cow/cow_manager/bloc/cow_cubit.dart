...
//   final FoodSuggestionRepository _foodSuggestionRepository;
//   CowCubit(this._cowRepository, this._foodSuggestionRepository)
//       : super(CowInitial());
...
//   Future<void> getListFoodSuggestion() async {
//     try {
//       //emit(WeatherLoading());
//       final FoodSuggestionModel foodSuggestionModel =
//           await _foodSuggestionRepository.getAllFoodSuggestion();
//       emit(FoodSuggestionLoaded(foodSuggestionModel));
//     } catch (Exception) {
//       emit(Exception("Kiểm tra lại kết nối của bạn"));
//     }
//   }
