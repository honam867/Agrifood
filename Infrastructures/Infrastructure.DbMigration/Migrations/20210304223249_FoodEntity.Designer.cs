...
namespace Infrastructure.DbMigration.Migrations
{
    ...
    [Migration("20210304223249_FoodEntity")]
            ...
            modelBuilder.Entity("ApplicationDomain.Identity.Entities.FarmerPermission", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 697, DateTimeKind.Unspecified).AddTicks(5157), new TimeSpan(0, -8, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 707, DateTimeKind.Unspecified).AddTicks(9420), new TimeSpan(0, -8, 0, 0, 0)));
            ...
            modelBuilder.Entity("ApplicationDomain.Identity.Entities.MenuPermission", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 726, DateTimeKind.Unspecified).AddTicks(9400), new TimeSpan(0, -8, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 726, DateTimeKind.Unspecified).AddTicks(9969), new TimeSpan(0, -8, 0, 0, 0)));
            ...
            modelBuilder.Entity("ApplicationDomain.Identity.Entities.PermissionGroup", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 727, DateTimeKind.Unspecified).AddTicks(9863), new TimeSpan(0, -8, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 728, DateTimeKind.Unspecified).AddTicks(604), new TimeSpan(0, -8, 0, 0, 0)));
            ...
            modelBuilder.Entity("ApplicationDomain.Identity.Entities.PermissionMembership", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 736, DateTimeKind.Unspecified).AddTicks(2181), new TimeSpan(0, -8, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 4, 14, 32, 48, 736, DateTimeKind.Unspecified).AddTicks(2851), new TimeSpan(0, -8, 0, 0, 0)));
